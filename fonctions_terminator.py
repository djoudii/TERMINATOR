...
# ------------------------------ Pseudo Main -------------------------------- #
###############################################################################
source = "Body slender, slightly arcuate ventrally when relaxed, anteriorly tapering from the level of oesophageal glands to the head which is one half of the body width. Cuticular striations 0.9 to 1.1 µm apart on midbody. Lateral field with 4 incisures, one fourth to one fifth of body width. In en face view, the pore like amphids are on outer margins of lateral lips; 4 papillae, one on each submedian lip (Fig. 1, B). Lip region non-striated and set off from body by a constriction as wide as or slightly wider than adjacent body; labial framework weakly developed; cheilorhabdions well sclerotized. Basal knobs of spear distinct, 2 µm across. Procorpus cylindrical; median oesophageal bulb oval-elongate, one and a half times to twice as long as wide, with refractive valvular apparatus slightly posterior to centre. Oesophageal glands extending over intestine 5 to 8 body widths. Excretory pore at 58 to 83 pm from anterior end, level with or slightly anterior to nerve ring. Hemizonid distinct in specimens from rice seeds (but not from cultured specimens), 11 to 15 µm behind excretory pore; hemizonion 20 to 30 µm behind hemizonid, usually difficult to see. Tait straight, slender, regularly tapering to a narrowly rounded end, 3.5 to 5 anal body diameters long; mucro with 3 to 4 processes as illustrated in Fig. 1, G-H. Ovary not extending to oesophageal glands; oocytes in 2 to 4 rows; spermatheca very conspicuous, elongate oval, full of rounded sperms showing a central nucleolus usually surrounded by a circle of black dots of unknown nature (Fig. l, A). Postvulval uterine sac short, slender and extending up to one fourth of the distance from vulva to anus (2.5 to 3 body diameters) often found empty and collapsed but more conspicuous and rounded in nematodes from cultured specimens but without sperms. Vulval lips slightly protruding."
