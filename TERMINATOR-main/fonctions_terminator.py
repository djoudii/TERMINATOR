...
# ------------------------------ Pseudo Main -------------------------------- #
###############################################################################
#source = "The body is slender, with a slight ventral arc when in a relaxed state, tapering anteriorly from the level of the oesophageal glands to the head, which constitutes one-half of the body width. Cuticular striations are observed 0.9 to 1.1 µm apart on the midbody. The lateral field exhibits four incisures, measuring one-fourth to one-fifth of the body width. In an en face view, the pore-like amphids are located on the outer margins of the lateral lips, accompanied by four papillae, one on each submedian lip (Fig. 1, B). The lip region is non-striated and set off from the body by a constriction as wide as or slightly wider than the adjacent body. The labial framework is weakly developed, with well-sclerotized cheilorhabdions. The basal knobs of the spear are distinct, measuring 2 µm across. The procorpus is cylindrical; the median oesophageal bulb is oval-elongate, one and a half to twice as long as wide, with a refractive valvular apparatus slightly posterior to the center. Oesophageal glands extend over the intestine by 5 to 8 body widths. The excretory pore is located at 58 to 83 µm from the anterior end, level with or slightly anterior to the nerve ring. The hemizonid is distinct in specimens from rice seeds (but not from cultured specimens), positioned 11 to 15 µm behind the excretory pore. The hemizonion is 20 to 30 µm behind the hemizonid, usually difficult to see. The tail is straight, slender, regularly tapering to a narrowly rounded end, measuring 3.5 to 5 anal body diameters long; the mucro has 3 to 4 processes, as illustrated in Fig. 1, G-H. The ovary does not extend to the oesophageal glands; oocytes are arranged in 2 to 4 rows; the spermatheca is very conspicuous, elongate oval, full of rounded sperms showing a central nucleolus, usually surrounded by a circle of black dots of unknown nature (Fig. 1, A). The postvulval uterine sac is short and slender, extending up to one-fourth of the distance from vulva to anus (2.5 to 3 body diameters), often found empty and collapsed but more conspicuous and rounded in nematodes from cultured specimens, though without sperms. Vulval lips slightly protrude."
