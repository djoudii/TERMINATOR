...
def import_dico(nomDoc,nomSheet):
    # Need to write the title of the file with '' + xls extension
...
dico_values = import_dico('Fichier_Dictionnaire.xls',u'Standards_vals')
register(dico_values, 'valuesDico')
test1 = opening('valuesDico')
print(test1)

dico = import_dico('Fichier_Dictionnaire.xls',u'Organes')
